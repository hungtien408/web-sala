                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="col-4" colspan="2">
                                    <h3>
                                        <strong>
                                            <asp:Label ID="lbTotal" runat="server"></asp:Label></strong>VNĐ</h3>
                                </td>
                            </tr>
                            <%--  <tr>
                        <td colspan="3">
                            ...
                            <tr>
                                ...
                                <td class="col-4" colspan="2">
                                    <h3>
                                        ...
                                        <strong>
                                            <asp:Label ID="lbSubTotal" runat="server"></asp:Label></strong>VNĐ</h3>
                                </td>
                            </tr>
                        </tfoot>
                        <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="cart-des">
                                                ...
                                                <p>
                                                    <span>
                                                        Khối lượng: <%# Eval("ProductCode") %></span>
                                                </p>
                                            </div>
                                        </td>
                                        <td>
...
'*').Replace(',', '.').Replace('*', ',')%></strong>VNĐ</h3>
                                        </td>
                                        <td>
                                            <h3>
                                                <strong>
                                                    <%# string.Format("{0:##,###.##}", Convert.ToInt16(Eval("Quantity")) * Convert.ToDouble(Eval("ProductPrice"))).Replace('.', '*').Replace(',', '.').Replace('*', ',')%></strong>VNĐ</h3>
                                        </td>
                                        <td>
        ...
        <asp:LinkButton ID="lkbUpdate" class="btn-a btn-cart" runat="server" OnClick="lkbUpdate_Click"
            ValidationGroup="giohang">Thanh toán</asp:LinkButton>
        <a class="btn-a btn-cart" href="online-shopping.aspx">chọn thêm sản phẩm</a>
    </div>
