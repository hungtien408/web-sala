<%@ Page Title="" Language="C#" MasterPageFile="~/site-cart.master" AutoEventWireup="true"
    CodeFile="info-payment.aspx.cs" Inherits="info_payment" %>
    ...
    <div class="wrapcart-content">
                        ...
                        <td>
                            <fieldset class="addres-info">
                                <div class="info-input">
                                    ...
                                    <div class="info-text">
                                        <asp:TextBox ID="txtFullName1" CssClass="info-textbox" runat="server" placeholder="-- Họ và tên --"
                                            Text=""></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Information"
                                            ControlToValidate="txtFullName1" runat="server" ErrorMessage="Thông tin bắt buộc!"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="info-input">
                                    <label class="info-lb">
                                    ...
                                    <div class="info-text">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="Information"
                                            ControlToValidate="txtPhone1" runat="server" ErrorMessage="Thông tin bắt buộc!"></asp:RequiredFieldValidator>
                                ...
                                <div class="info-input">
                                    ...
                                    <div class="info-text">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="Information"
                                            ControlToValidate="txtEmail1" runat="server" ErrorMessage="Thông tin bắt buộc!"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <%--  <div class="info-input">
                                    <label class="info-lb">
                                ...
                                <div class="info-input">
                                    ...
                                    <div class="info-text">
                                        <asp:TextBox ID="txtAddress1" CssClass="info-textbox" runat="server" Text="" placeholder="-- Địa chỉ --"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="Information"
                                            ControlToValidate="txtAddress1" runat="server" ErrorMessage="Thông tin bắt buộc!"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="info-input">
                                    <label class="info-lb info-l16">
                                ...
                                <div class="info-input">
                                    <div class="info-text">
                                        <asp:CheckBox ID="chkAgee" Checked="True" runat="server" Text="Tôi đã đọc, hiểu và đồng ý với các điều khoản của Sala Boutique"
                                    ...
                                    <asp:ListView ID="lstShoppingCart" runat="server" DataSourceID="odsCart" EnableModelValidation="True">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <strong>
                                                        <%# Eval("ProductName") + "<br/>" + Eval("ProductCode")%></strong>
                                                </td>
                                                <td>
                                                    <strong>
                                                        <%# Eval("Quantity") %></strong>
                                                </td>
                                                <td>
                                                    <strong>
                                                        <%# string.IsNullOrEmpty(Eval("ProductPrice").ToString()) ? "0" : (string.Format("{0:##,###.##}", Convert.ToInt16(string.IsNullOrEmpty(Eval("Quantity").ToString()) ? 0 : Eval("Quantity")) * Convert.ToDouble(string.IsNullOrEmpty(Eval("ProductPrice").ToString()) ? 0 : Eval("ProductPrice"))).Replace('.', '*').Replace(',', '.').Replace('*', ','))%></strong>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <LayoutTemplate>
        ...
        <div class="btn-button-tk">
            <asp:Button ID="btnOrder" runat="server" ValidationGroup="Information" CssClass="btn-button btn-order"
                OnClick="btnOrder_Click" Text="Hoàn thành đơn đặt hàng" />
            <a class="btn-button btn-order" href="cart.aspx">Quay lại giỏ hàng</a>
        </div>
    </div>
</asp:Content>
