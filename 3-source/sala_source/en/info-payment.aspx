<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-cart.master" AutoEventWireup="true" CodeFile="info-payment.aspx.cs" Inherits="info_payment" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="wrapcart-content">
        <h1 class="title-4">Info Payment</h1>
        <div class="cart-w">
            <table class="tb-wrap tb-infoacc" cellpadding="0" cellspacing="0">
                <thead>
                    <tr>
                        <th>
                            <h1 class="title-info">Ship address</h1>
                        </th>
                        <th>
                            <h1 class="title-info">Payment method</h1>
                        </th>
                        <th>
                            <h1 class="title-info">Info cart</h1>
                        </th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <td>
                            <fieldset class="addres-info">
                                <div class="info-input">
                                    <label class="info-lb">
                                        <span class="error-lb">*</span>Fullname</label>
                                    <div class="info-text">
                                        <asp:TextBox ID="txtFullName1" CssClass="info-textbox" runat="server" placeholder="-- Fullname --" Text=""></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Information" ControlToValidate="txtFullName1" runat="server" ErrorMessage="Infomation required!"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="info-input">
                                    <label class="info-lb">
                                        <span class="error-lb">*</span>Phone</label>
                                    <div class="info-text">
                                        <asp:TextBox ID="txtPhone1" CssClass="info-textbox" runat="server" placeholder="0909******"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="Information" ControlToValidate="txtPhone1" runat="server" ErrorMessage="Infomation required!"></asp:RequiredFieldValidator>
                                       <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtPhone1"
                                            Display="Dynamic" ErrorMessage="Please type number!" ValidationExpression="^[0-9]+$"
                                            ValidationGroup="Information"></asp:RegularExpressionValidator></div>
                                </div>
                                <div class="info-input">
                                    <label class="info-lb">
                                        <span class="error-lb">*</span>Email</label>
                                    <div class="info-text">
                                        <asp:TextBox ID="txtEmail1" CssClass="info-textbox" runat="server" placeholder="-- Email --"></asp:TextBox>
                                        <asp:RegularExpressionValidator CssClass="lb-error" ID="RegularExpressionValidator1" runat="server" ValidationGroup="Information"
                                            ControlToValidate="txtEmail1" ErrorMessage="Wrong email format!" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                                            Display="Dynamic" ForeColor="Red"></asp:RegularExpressionValidator>

                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="Information" ControlToValidate="txtEmail1" runat="server" ErrorMessage="Infomation required!"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <%--  <div class="info-input">
                                    <label class="info-lb">
                                ...
                                <div class="info-input">
                                    <label class="info-lb info-l16">
                                        <span class="error-lb">*</span>Address</label>
                                    <div class="info-text">
                                        <asp:TextBox ID="txtAddress1" CssClass="info-textbox" runat="server" Text="" placeholder="-- Address --"></asp:TextBox>

                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="Information" ControlToValidate="txtAddress1" runat="server" ErrorMessage="Infomation required!"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="info-input">
                                    <label class="info-lb info-l16">
                                ...
                                <div class="info-input">
                                    <label class="info-lb info-l16">
                                        Payment regulations</label>
                                    <div class="info-text">
                                        <div class="info-areatext">
                                            <p>
                                                Cám ơn quý khách đã truy cập vào website Sala Boutique được vận hành bởi Sala Boutique.
                                                Chúng tôi tôn trọng và cam kết sẽ bảo mật những thông tin mang tính riêng tư của
                                                bạn. Xin vui lòng đọc bản Chính sách bảo mật dưới đây để hiểu hơn những cam kết
                                            ...
                                            <p>
                                                ...
                                                sử dụng và tiết lộ thông tin cá nhân của mình.
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                thể biết bạn là ai nếu bạn không đăng nhập vào tài khoản của mình.
                                            </p>
                                            <h2>
                                            ...
                                            <p>
                                                ...
                                                cứ thông tin tiếp thị của chúng tôi thì có thể từ chối bất cứ lúc nào.
                                            </p>
                                            <p>
                                                Chúng tôi có thể chuyển tên và địa chỉ cho bên thứ ba để họ giao hàng cho bạn (ví
                                                dụ cho bên chuyển phát nhanh hoặc nhà cung cấp).
                                            </p>
                                            <p>
                                                ...
                                                tin chính xác, không gây nhầm lẫn và phải thông báo cho chúng tôi nếu có thay đổi.
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                rõ, chúng tôi sẽ liên lạc với bạn.
                                            </p>
                                            <p>
                                                ...
                                                này không có khả năng xác định cá nhân.
                                            </p>
                                            <h3>
                                                Cuộc thi</h3>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                xuất hiện của kênh Hiển Thị Quảng Cáo trên Google
                                            </p>
                                            <p>
                                                Sala Boutique và các nhà cung cấp bên thứ ba, bao gồm Google, có thể sử dụng cookies
                                            ...
                                            <p>
                                                ...
                                                về bạn theo cách thức và các mục đích nêu trên.
                                            </p>
                                            <h2>
                                                3. Bảo mật</h2>
                                            <p>
                                                ...
                                                đôi khi yêu cầu giấy tờ chứng minh trước khi tiết lộ thông tin cá nhân cho bạn.
                                            </p>
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                pháp Việt Nam và tòa án Việt Nam có thẩm quyền xem xét.
                                            </p>
                                            <h2>
                                ...
                                <div class="info-input">
                                    <div class="info-text">
                                        <asp:CheckBox ID="chkAgee" Checked="True" runat="server" Text="I read, and agree with all regulation of Sala Boutique"
                            ...
                            <ul class="list-cart">
                                <li id="rbtMoneyShow" runat="server">
                                    ...
                                    <label for="RadioButton1">
                                        <img src="../assets/images/icon-cart-1.png" alt="" />Cash</label>
                                </li>
                                <%-- <li>
                                ...
                                <li>
                                    ...
                                    <label for="RadioButton4">
                                        <img src="../assets/images/icon-cart-4.png" alt="" />Payment by direct bank transfer.
                                        <div class="sendemailtext">
                                            ...
                                            <asp:ObjectDataSource ID="ObjectDataSource4" runat="server"
                                                ...
                                                <SelectParameters>
                                                    ...
                                                    <asp:Parameter Name="ArticleCategoryID" Type="String" DefaultValue="3" />
                            ...
                            <table class="tb-cart-2" cellpadding="0" cellspacing="0">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            <strong>
                                                <asp:Label ID="lblTotalPrice" runat="server" Text="Label"></asp:Label></strong>
                                        </td>
                                    </tr>
                                    <%--  <tr>
                                        <td colspan="2">
                                ...
                                <tbody>
                                    <asp:ListView ID="lstShoppingCart" runat="server"
                                        DataSourceID="odsCart" EnableModelValidation="True">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <strong><%# Eval("ProductName") + "<br/>" + Eval("ProductCode")%></strong>
                                                </td>
                                                <td>
                                                    <strong><%# Eval("Quantity") %></strong>
                                                </td>
                                                <td>
                                                    <strong><%# string.IsNullOrEmpty(Eval("ProductPrice").ToString()) ? "0" : (string.Format("{0:##,###.##}", Convert.ToInt16(string.IsNullOrEmpty(Eval("Quantity").ToString()) ? 0 : Eval("Quantity")) * Convert.ToDouble(string.IsNullOrEmpty(Eval("ProductPrice").ToString()) ? 0 : Eval("ProductPrice"))).Replace('.', '*').Replace(',', '.').Replace('*', ','))%></strong>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <LayoutTemplate>
        ...
        <div class="btn-button-tk">
            <asp:Button ID="btnOrder" runat="server" ValidationGroup="Information" CssClass="btn-button btn-order" OnClick="btnOrder_Click"
                Text="Complete order" />
            <a class="btn-button btn-order" href="cart.aspx">Come back cart</a>
        </div>
    </div>
</asp:Content>
