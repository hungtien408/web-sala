...
//Thay dia chi web
var endAddress = "10.846145, 106.640584";
//Thay toa do
var lat = 10.846145, long = 106.640584;
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        // Creating the content  
            ...
            '<li class="local">Địa chỉ: 51/51 Pham Van Chieu Street, Ward 14, Go Vap District, TP. HCM</li>' +            '<li class="phone">Hotline: 0932.110.577</li>' +
            '<li class="web">Website: www.salaboutique.net</li>' +
            '<li class="mail">Email: <a href="mailTo:hello@salaboutique.net">hello@salaboutique.net</a></li>' + '</ul>'
        '</div>';
