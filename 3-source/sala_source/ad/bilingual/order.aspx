...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        ...
        <asp:RadGrid ID="RadGrid1" runat="server" Culture="vi-VN" AllowMultiRowSelection="True"
            ...
            OnItemDataBound="RadGrid1_ItemDataBound" PageSize="50" CssClass="grid" AllowPaging="True"
            AllowSorting="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
            CellSpacing="0" OnItemCreated="RadGrid1_ItemCreated">
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="Mã đặt hàng" DataField="OrderID" SortExpression="OrderID">
                    </asp:GridBoundColumn>
                    <%--<asp:GridBoundColumn Visible="false" HeaderText="Công ty" DataField="CompanyName"
                    ...
                    <asp:GridBoundColumn Visible="false" HeaderText="Di động" DataField="CellPhone" SortExpression="CellPhone">
                    </asp:GridBoundColumn>
                    <asp:GridBoundColumn HeaderText="Email" DataField="Email" SortExpression="Email">
                    </asp:GridBoundColumn>
                    <asp:GridBoundColumn HeaderText="Tạo bởi" DataField="UserName" SortExpression="UserName" Visible="False">
                    </asp:GridBoundColumn>
                ...
                <NestedViewTemplate>
                    ...
                    <asp:RadGrid ID="RadGrid2" runat="server" Culture="vi-VN" AllowMultiRowSelection="True"
                        ...
                        <MasterTableView CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                            AllowMultiColumnSorting="True" DataKeyNames="OrderDetailID" Width="700px" Style="border: 1px solid #999;
                            margin-left: 50px">
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="OrderDetailDelete"
                        InsertMethod="OrderDetailInsert" SelectMethod="OrderDetailSelectAll" TypeName="TLLib.OrderDetail"
                        UpdateMethod="OrderDetailUpdate">
                        <DeleteParameters>
                        ...
                        <InsertParameters>
                            ...
                            <asp:Parameter Name="ProductColorNameEn" Type="String" />
                        </InsertParameters>
                        <SelectParameters>
                            <asp:Parameter Name="OrderDetailID" Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="OrdersSelectAll"
