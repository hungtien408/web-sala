        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn DataField="IsBestSeller" HeaderText="Tiếng Việt" SortExpression="IsBestSeller">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn DataField="IsSaleOff" HeaderText="Tiếng Anh" SortExpression="IsSaleOff">
                        <ItemTemplate>
