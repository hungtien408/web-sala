...
public partial class ad_single_product : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string ProductName = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtProductName")).Content.Trim())); //((RadTextBox)row.FindControl("txtProductName")).Text.Trim();
            ...
            string ProductNameEn = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtProductNameEn")).Content.Trim())); //((RadTextBox)row.FindControl("txtProductNameEn")).Text.Trim();
